window.onload = function() {
  ...
  IP_Addr.addEventListener("input", function(event) {
    if(IP_Addr.validity.patternMismatch) {
      IP_Addr.setCustomValidity("IP Address invalid");
...
function possible_network(ip, subnet, num_host) {
  var div_table_3 = document.getElementById("tb3");
...
function get_result() {
  ...
  // Add To HTML
  var div_table_2 = document.getElementById("tb2");
  ...
  if (subnet != 32 && subnet != 24 && subnet != 16 && subnet != 8 && ip != "") {
